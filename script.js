...
const kysymykset = {
  ...
  en_ikinä: [
    ...
    "...ollut ihastunut opettajaan/työkaveriin",
    ...
    "...lähettänyt flirttailevaa viestiä, jonka tarkoitus oli selvästi enemmän kuin “viaton”",
    ...
    "...käyttänyt jotain iskurepliikkiä (vakavasti tai vitsillä)",
    ...
    "...testannut rajoja ihan vain nähdäkseni mitä tapahtuu",
    "...ollut tilanteessa, jossa tiesin tekeväni jotain vähän “huonoa ideaa” mutta tein silti",
